...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::spotlight_cmd::add_spotlight_history,
            commands::spotlight_cmd::get_spotlight_history,
            commands::spotlight_cmd::remove_spotlight_history,
            commands::spotlight_cmd::clear_spotlight_history,
